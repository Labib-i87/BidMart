...
@section('content')
    <div class="container p-0">
        <div class="card px-4">
            ...
            <div class="row gx-3">
                <form action="{{ route('buy-product', $product->pid) }}" enctype="multipart/form-data" method="GET">
                    ...
                    <div class="col-6">
                        <div class="d-flex flex-column">
                            ...
                            <p class="text mb-1">{{ $product->current_price - 0 }} - {{ 1000 }} =
                                {{ $product->current_price - 1000 }} TK</p>
                        </div>
                    </div>
                    <br>

                    <button type="submit" class="btn btn-primary mb-4">Pay {{ $product->current_price - 1000 }}
                        TK</button>
                </form>
            </div>
        </div>
